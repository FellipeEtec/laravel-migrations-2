...
--
CREATE DATABASE IF NOT EXISTS `fornecedores` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `fornecedores`;
...
CREATE TABLE `estoque` (
  ...
  `cadastroid` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `estoque`
  ADD PRIMARY KEY (`id`),
  ADD KEY `estoque_cadastroid_foreign` (`cadastroid`);
...
--
ALTER TABLE `estoque`
  ADD CONSTRAINT `estoque_cadastroid_foreign` FOREIGN KEY (`cadastroid`) REFERENCES `cadastro` (`id`) ON DELETE CASCADE;
COMMIT;
